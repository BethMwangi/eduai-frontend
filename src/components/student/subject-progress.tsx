            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <span className="text-3xl">
                  {getSubjectIcon(subjectData?.display_name || subjectName)}
                </span>
                <div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-green-600 mt-1">
                    {subjectProgress?.total_questions_attempted || 0} attempted
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-green-600 mt-1">
                    {subjectProgress?.total_questions_correct || 0} correct
                    answers
                  </p>
                </div>
                ...
                >
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <CardDescription className="mt-1">
                          {topic.questions_attempted}/{topic.total_questions}{" "}
                          questions attempted
                        </CardDescription>
                      </div>
                      <Badge
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="text-xs text-gray-500 border-t pt-3">
                      Last studied: {formatLastActivity(topic.last_activity)}
                    </div>
        ...
        {topicProgress.length === 0 && (
          <div className="text-center py-12">
            ...
            <Link href={`/student/question-pool?subject_id=${subjectData?.id}`}>
              <Button>
                <Play className="w-4 h-4 mr-2" />
                Start Learning
              </Button>
