...
export function QuestionCard({ question, layoutMode, getDifficultyColor }: QuestionItemProps) {
  if (layoutMode === "list") {
    return (
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
      <div className="mb-3">
        <h3 className="font-medium text-gray-900 mb-2 line-clamp-2">{question.question}</h3>
